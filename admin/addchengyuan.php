	...
	<table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td height="20" bgcolor="royalblue">
				<div align="center" class="style1">添加成员</div>
			</td>
		</tr>
		<tr>
			<td height="175" bgcolor="#666666">
				<table width="548" height="205" border="0" align="center" cellpadding="0" cellspacing="1">
					<form name="form1" method="post" action="savenewchengyuan.php" onSubmit="return chkinput(this)">
						<tr>
							<td width="73" height="25" bgcolor="#FFFFFF">
								<div align="center">成员名称：</div>
							</td>
							<td width="472" bgcolor="#FFFFFF">
								<div align="left"><input type="text" name="mingcheng" size="50" class="inputcss"></div>
							</td>
						</tr>
						<tr>
							<td height="125" bgcolor="#FFFFFF">
								<div align="center">成员简介：</div>
							</td>
							<td height="125" bgcolor="#FFFFFF">
								<div align="left"><textarea name="jianjie" rows="8" cols="65"></textarea>
								</div>
							</td>
						</tr>
						<tr>
							<td height="125" bgcolor="#FFFFFF">
								<div align="center">成员图片：</div>
							</td>
							<td height="125" bgcolor="#FFFFFF">
								<div align="left"><input type="hidden" name="MAX_FILE_SIZE" value="2000000">
						...
						<tr>
							<td height="25" colspan="2" bgcolor="#FFFFFF">
								<div align="center"><input type="submit" value="添加" class="buttoncss">&nbsp;&nbsp;<input
										type="reset" value="重写" class="buttoncss"></div>
							</td>
						</tr>
					</form>
				</table>
