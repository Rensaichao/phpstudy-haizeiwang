  ...
  * License: https://bootstrapmade.com/license/
  ...
  <main id="main" class="main">
	...
	<table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
	  <tr>
	    <td height="20" bgcolor="royalblue"><div align="center" class="style1">添加用户</div></td>
	  </tr>
	  <tr>
	    <td height="175" bgcolor="#666666"><table width="548" height="205" border="0" align="center" cellpadding="0" cellspacing="1">
	      <form name="form1" method="post" action="savenewuser.php" onSubmit="return chkinput(this)">
		  <tr>
	        <td width="73" height="25" bgcolor="#FFFFFF"><div align="center">用户名：</div></td>
	        <td width="472" bgcolor="#FFFFFF"><div align="left"><input type="text" name="name" size="50" class="inputcss"></div></td>
	      </tr>
	      <tr>
	        <td width="73" height="25" bgcolor="#FFFFFF"><div align="center">密码：</div></td>
	        <td width="472" bgcolor="#FFFFFF"><div align="left"><input type="text" name="pwd" size="50" class="inputcss"></div></td>
	      </tr>
	      <tr>
