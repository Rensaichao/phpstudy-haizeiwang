  ...
  * License: https://bootstrapmade.com/license/
  ...
  <main id="main" class="main">
	...
	<?php
	 ...
	 $sql=mysql_query("select * from tb_admin where id=".$_GET[id]."",$conn);      
	...
	<table width="550" border="0" align="center" cellspacing="0">
	  <tr>
	    <td height="20" bgcolor="#FFCF60"><div align="center" class="style1">修改用户信息</div></td>
	  </tr>
	  <tr>
	    <td bgcolor="#666666"><table width="556" border="0" align="center" cellpadding="0" cellspacing="1">
	       <form name="form1" method="post" action="saveedituser.php" onSubmit="return chkinput(this)">
		  
		  <tr>
	        <td width="84" height="25" bgcolor="#FFFFFF"><div align="center">用户名</div></td>
	        <td width="469" height="25" bgcolor="#FFFFFF"><div align="left"><input type="text" name="name" size="50" class="inputcss" value="<?php echo $info[name];?>"></div></td>
	      </tr>
	      <tr>
	        <td bgcolor="#FFFFFF"><div align="center">密码：</div></td>
	       <td width="469" height="25" bgcolor="#FFFFFF"><div align="left"><input type="text" name="pwd" size="50" class="inputcss" value="<?php echo $info[pwd];?>"></div></td>        </div></td>
	      </tr>
	      <tr>
