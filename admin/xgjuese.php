  ...
  * License: https://bootstrapmade.com/license/
  ...
  <main id="main" class="main">
	...
	<?php 
	          ...
	          $sql1=mysql_query("select * from tb_xuanshangling where id=".$_GET[id]."",$conn);
	          $info1=mysql_fetch_array($sql1);
	        ?>
	
	<table width="580" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td height="20" bgcolor="royalblue">
				<div align="center" class="style1">更改角色信息</div>
			</td>
		</tr>
		<tr>
			<td height="253" bgcolor="#666666">
				<table width="582" border="0" cellpadding="0" cellspacing="1">
					...
					<form name="form1" enctype="multipart/form-data" method="post"
						action="savexgjuese.php?id=<?php echo $_GET[id];?>" onSubmit="return chkinput(this)">
						<tr>
							...
							<td width="506" bgcolor="#FFFFFF">
								<div align="left">
									<input type="text" name="mingcheng" size="25" class="inputcss"
										value="<?php echo $info1[mingcheng];?>">
								</div>
							</td>
						</tr>
						<tr>
	          ...
	          {
	         ?>
										<option <?php if(substr($info1[addtime],0,4)==$i){echo "selected";}?>>
											<?php echo $i;?></option>
										<?php 
	          }
	         ?>
	                    ...
	                    for($i=1;$i<=12;$i++)
	                     {
	                    ?>
										<option <?php if(substr($info1[addtime],5,1)==$i){echo "selected";} ?>>
											<?php echo $i;?></option>
										<?php 
	                     }
	                     ?>
	                    ...
	                    for($i=1;$i<=31;$i++)
	                     {
	                    ?>
										<option <?php if(substr($info1[addtime],7,1)==$i){echo "selected";} ?>>
											<?php echo $i;?></option>
										<?php 
	                     }
	                     ?>
						...
						<tr>
							<td height="25" bgcolor="#FFFFFF">
								<div align="center">悬赏：</div>
							</td>
							<td height="25" bgcolor="#FFFFFF">
								<div align="left">悬赏金额：
									<input type="text" name="xuanshang" size="10" class="inputcss"
										value="<?php echo $info1[xuanshang];?>">
									元
								</div>
							</td>
						</tr>
	                    ...
	                    ?>
										<option value=<?php echo $info[id];?>
											<?php if($info1[typeid]==$info[id]) {echo "selected";}?>>
						...
						<tr>
							<td height="25" bgcolor="#FFFFFF">
								<div align="center">角色身份：</div>
							</td>
							<td width="476" height="22" bgcolor="#FFFFFF">
								<div align="left"><input type="text" name="shenfen" class="inputcss" size="20"
										value="<?php echo $info1[shenfen];?>"></div>
							</td>
						</tr>
						<tr>
							<td height="22" bgcolor="#FFFFFF">
								<div align="center">角色能力：</div>
							</td>
							<td width="476" height="25" bgcolor="#FFFFFF">
								<div align="left">
									<input type="text" name="nengli" class="inputcss" size="20"
										value="<?php echo $info1[nengli];?>">
								</div>
							</td>
						...
						<tr>
							<td height="25" bgcolor="#FFFFFF">
								<div align="center">角色称呼：</div>
							</td>
							<td width="476" height="25" bgcolor="#FFFFFF">
								<div align="left">
									<input type="text" name="chenghu" class="inputcss" size="20"
										value="<?php echo $info1[chenghu];?>">
								</div>
							</td>
						...
						<tr>
							<td height="25" bgcolor="#FFFFFF">
								<div align="center">等场时间：</div>
							</td>
							<td width="476" height="25" bgcolor="#FFFFFF">
								<div align="left">
									<input type="text" name="dengchang" class="inputcss" size="20"
										value="<?php echo $info1[dengchang];?>">
								</div>
							</td>
							</div>
			</td>
