  ...
  <main id="main" class="main">
	<style type="text/css">
	        ...
	        <?php
	               ...
	               $sql=mysql_query("select count(*) as total from tb_chengyuan ",$conn);
	               ...
	               else
	               {
	                   ...
	                   $sql1=mysql_query("select * from tb_chengyuan limit ".($page-1)*$pagesize.",$pagesize",$conn);
	        ?>
	        <form name="form1" method="post" action="deletechengyuan.php">
	        <table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
	          <tr>
	            <td height="20" bgcolor="royalblue"><div align="center" class="style1">管理草帽团成员</div></td>
	          </tr>
	          <tr>
	            <td height="50" bgcolor="#666666"><table width="548" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
	              ...
	              <tr>
	                ...
	                <td width="388" bgcolor="#FFFFFF"><div align="center">成员名称</div></td>
	              ...
	              <tr>
	                ...
	                <td height="25" bgcolor="#FFFFFF"><div align="center"><a href="editchengyuan.php?id=<?php echo $info1[id];?>">修改</a></div></td>
	              </tr>
	              <?php
	                   }
	            ...
	            <td width="388"><div align="right">
	             ...
	             <?php
	                ...
	                <?php
	                  ...
	                  {
	                  ?>
	                <a href="glnews.php?id=<?php echo $id;?>&page=1" title="首页"><font face="webdings"> 9 </font></a> 
	                <a href="glnews.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="前一页"><font face="webdings"> 7 </font></a>
	                <?php
	                  }
	                   if($pagecount<=4){
	                    for($i=1;$i<=$pagecount;$i++){
	                  ?>
	                <a href="glnews.php?id=<?php echo $id;?>&page=<?php echo $i;?>"><?php echo $i;?></a>
	                <?php
	                     }
	                   }else{
	                   for($i=1;$i<=4;$i++){	 
	                ...
	                <a href="glnews.php?id=<?php echo $id;?>&page=<?php echo $i;?>"><?php echo $i;?></a>
	                <?php }?>
	                <a href="glnews.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="后一页"><font face="webdings"> 8 </font></a>
	                 <a href="glnews.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="尾页"><font face="webdings"> : </font></a>
	                <?php }?>
	                </div></td>
	          </tr>
	        </table>
