  ...
  <main id="main" class="main">
	<style type="text/css">
	        ...
	        <?php
	               ...
	               $sql=mysql_query("select count(*) as total from tb_zixun ",$conn);
	               ...
	               else
	               {
	                   ...
	                   $sql1=mysql_query("select * from tb_zixun order by time desc limit ".($page-1)*$pagesize.",$pagesize",$conn);
	        ?>
	        <form name="form1" method="post" action="deletenews.php">
	        <table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
	          <tr>
	            <td height="20" bgcolor="royalblue"><div align="center" class="style1">管理资讯</div></td>
	          </tr>
	          <tr>
	            <td height="50" bgcolor="#666666"><table width="548" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
	              ...
	              <tr>
	                ...
	                <td width="388" bgcolor="#FFFFFF"><div align="center">资讯主题</div></td>
	              ...
	              <tr>
	                ...
	                <td height="25" bgcolor="#FFFFFF"><div align="center"><a href="editnews.php?id=<?php echo $info1[id];?>">修改</a></div></td>
	              </tr>
	              <?php
	                   }
