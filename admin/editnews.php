...
<?php
 ...
 $sql=mysql_query("select * from tb_zixun where id=".$_GET[id]."",$conn);      
...
<table width="550" border="0" align="center" cellspacing="0">
  <tr>
    <td height="20" bgcolor="#FFCF60"><div align="center" class="style1">编辑新闻</div></td>
  </tr>
  <tr>
    <td bgcolor="#666666"><table width="556" border="0" align="center" cellpadding="0" cellspacing="1">
       <form name="form1" method="post" action="saveeditnews.php" onSubmit="return chkinput(this)">
	  
	  <tr>
        <td width="84" height="25" bgcolor="#FFFFFF"><div align="center">编辑主题</div></td>
        <td width="469" height="25" bgcolor="#FFFFFF"><div align="left"><input type="text" name="title" size="50" class="inputcss" value="<?php echo $info[title];?>"></div></td>
      </tr>
      <tr>
        <td bgcolor="#FFFFFF"><div align="center">新闻内容：</div></td>
