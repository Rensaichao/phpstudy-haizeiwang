  ...
  * License: https://bootstrapmade.com/license/
  ...
  <main id="main" class="main">
	...
	<?php
	 ...
	 $sql=mysql_query("select * from tb_chengyuan where id=".$_GET[id]."",$conn);      
	...
	<table width="550" border="0" align="center" cellspacing="0">
	  <tr>
	    <td height="20" bgcolor="#FFCF60"><div align="center" class="style1">更改成员信息</div></td>
	  </tr>
	  <tr>
	    <td bgcolor="#666666"><table width="556" border="0" align="center" cellpadding="0" cellspacing="1">
	       <form name="form1" method="post" action="saveeditchengyuan.php" onSubmit="return chkinput(this)">
		  
		  <tr>
	        <td width="84" height="25" bgcolor="#FFFFFF"><div align="center">名称</div></td>
	        <td width="469" height="25" bgcolor="#FFFFFF"><div align="left"><input type="text" name="mingcheng" size="50" class="inputcss" value="<?php echo $info[mingcheng];?>"></div></td>
	      </tr>
	      <tr>
	        <td bgcolor="#FFFFFF"><div align="center">简介：</div></td>
	        <td bgcolor="#FFFFFF"><div align="left"><textarea name="jianjie" cols="60" rows="8" class="inputcss"><?php echo $info[jianjie];?></textarea>
	        </div></td>
	      </tr>
	      <tr>
